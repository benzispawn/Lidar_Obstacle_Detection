...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI> pointProcessor, const pcl::PointCloud<pcl::PointXYZI>::Ptr inputCloud)
{
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr filterCloud = pointProcessor.FilterCloud(inputCloud, 0.2f, Eigen::Vector4f(-10,-5,-3, 1), Eigen::Vector4f(30,8,3, 1));
    //(-15,-6.5,-2.5, 1) (30.0,6.5,2.5, 1)
    ...
    //CLUSTER  
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessor.Clustering(segmentCloud.first, .53, 10.0, 500);
